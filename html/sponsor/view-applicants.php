...
if (isset($_POST["acceptId"])) {
    ...
    $driver = $db->LoadUserFromId(UserAccount::DRIVER_ACCOUNT, $_POST["acceptId"]);
    $n = new Notification(UserAccount::DRIVER_ACCOUNT, $_POST["acceptId"]);
    $n->SetText("Your application to {$user->GetUsername()} has been accepted!");
    $n->Post();
}
    ...
    $driver = $db->LoadUserFromId(UserAccount::DRIVER_ACCOUNT, $_POST["rejectId"]);
    $n = new Notification(UserAccount::DRIVER_ACCOUNT, $_POST["rejectId"]);
    $n->SetText("Your application to {$user->GetUsername()} has been rejected! :(");
    $n->Post();
}
