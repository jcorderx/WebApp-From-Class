...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 $queryStr = "INSERT INTO Sponsors VALUES (NULL, '{$comp}','{$uname}', '{$email}', '{$passhash}', '{$phone}');";
...
// header("Location: adduser.php");
 //exit;
  ...
  <center>  <h2>Add a sponsor</h2> </center>
  </div>

<form action="addsponsor.php" method="post" style="border:1px solid #ccc">
  <div class="container">
    ...
    <input type="text" class="form-control" placeholder="company bame" name="comp" required>
    <br>
