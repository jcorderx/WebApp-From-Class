...
function PrintItems(&$items, $sponsor, $user) {
                ...
                <div class=\"item-preview-description\">
                    ...
                    <div class=\"item-cost-panel\">
                        <table>
                            <tr style=\"box-shadow:0 0 3px green;background-color:#d6ffc9;\">
                                ...
                                <td><span class=\"price-text\">{$total}</span> Credits</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class=\"d-flex align-items-center\">
                        <div class=\"d-flex justify-content-center\">
                            <a href=\"cart-Submission-Page.php?itemId={$item->GetID()}&sponsorId={$sponsor->GetID()}\" class=\"btn btn-primary mr-3 mb-1\">Add to Cart</a>
...
<body>
    ...
    <div class="container">
        <?php
            echo "
                <div class=\"jumbotron text-center\">
                    ...
                    <p class=\"lead\">You have {$user->credits[$sponsor->GetID()]} credits.</p>
                </div>
            ";
        ?>
        ...
        <div class="d-flex flex-wrap">
            <?php PrintItems($items, $sponsor, $user); ?>
        </div>
    </div>
