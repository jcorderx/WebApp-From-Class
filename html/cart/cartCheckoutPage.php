...
$items = $db->GetCatalogItemsFromQuery("SELECT * FROM CatalogItems WHERE id IN (SELECT cid FROM cart WHERE did={$user->GetID()});");

echo $items;
//$item->title
//use this to get item names
//foreach ($items as $the_individual_item) {...}
?>
